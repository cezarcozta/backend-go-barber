...
let ResetPasswordService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if (!userToken) {
      throw new _AppError.default('User Token dos not exists');
    }
    ...
    const compare = (0, _dateFns.addHours)(tokenDate, 2);

    if ((0, _dateFns.isAfter)(Date.now(), compare)) {
      throw new _AppError.default('Token has expired');
    }
